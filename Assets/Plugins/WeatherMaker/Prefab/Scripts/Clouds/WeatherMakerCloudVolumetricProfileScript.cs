...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerCloudVolumetricProfileScript : ScriptableObject
    {
        ...
        /// <summary>Cloud ray march parameters. X: min step, Y: max step, Z: min to max step lerp (0-1)</summary>
        [Tooltip("Cloud ray march parameters. X: min step, Y: max step, Z: min to max step lerp (0-1), W: Optical depth ray march multiplier")]
        public Vector4 CloudRayMarchParameters = new Vector4(512.0f, 512.0f, 0.0f, 4.0f);
